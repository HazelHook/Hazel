  ...
  return (
    <>
      <Card>
        ...
        <div
          className="p-2 flex flex-col gap-4 cursor-pointer"
        ...
        >
          ...
          <div className="flex flex-row justify-between gap-4">
            <div>
              ...
              <p className="text-sm">
                {dashboardNumberFormatter().format(data.stats.day)}
              </p>
            </div>
            <div>
              <p className="text-xs text-muted-foreground">30d</p>
              <p className="text-sm">
                {dashboardNumberFormatter().format(data.stats.month)}
              </p>
            </div>
          </div>
        </div>
        ...
        <SheetContent className="space-y-6">
          <SheetHeader className="space-y-6">
            ...
            <div className="w-full flex flex-col items-start gap-2">
              ...
              <div className="flex flex-row gap-2 items-center">
                ...
                <div className="flex flex-row gap-2 items-center">
                  <div
                    className={cn(
                      "bg-green-500",
                      "relative inline-flex h-3 w-3 rounded"
                    )}
                  />
                  <p>Working</p>
                </div>
              ...
              <div className="flex flex-row gap-2 items-center">
                <p className="text-muted-foreground text-sm w-24">
                  Last Update
                </p>
                <p>
                  {formatDistance(new Date(data.source.updatedAt), new Date())}
                </p>
              </div>
              <div className="flex flex-row gap-2 items-center">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Verify the origin of your webhook by assigning a host or use one
                of our integrations for your provider
              </p>
            </div>
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="flex flex-row items-center gap-2">
                ...
                <p className="flex-grow w-full text-xs text-muted-foreground">
                  OR
                </p>
