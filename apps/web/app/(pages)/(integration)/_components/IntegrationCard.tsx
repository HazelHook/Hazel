...
import { DialogContent, Portal, Root, Trigger } from "@radix-ui/react-dialog"
...
export const IntegrationCard = ({integration: {
  ...
  features,
  form
},isModalOpen,setModalOpen}: {integration: Integration, isModalOpen: boolean, setModalOpen: (open: boolean) => void}) => {
...
//                 </div>
//                 <Separator />
//                 <IntegrationFormModal integration={form} onSubmit={() => setModalOpen(false)} />
//               </Card>
//             </DialogContent>
//           ) : null}
//         </Portal>
