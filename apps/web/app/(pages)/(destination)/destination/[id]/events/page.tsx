...
async function fetch({ customer_id, destination_id }: { customer_id: string; destination_id: string }) {
	const destinations = await tiny.getRes({
		customer_id,
		destination_id,
	})
	...
	return (
		<div>
			<div className="w-full">
				<TableWrapper data={destinations.data} maxItems={destinations.rows_before_limit_at_least || destinations.data.length} destination={destination} />
			</div>
		</div>
	)
}
