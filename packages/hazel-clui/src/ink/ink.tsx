...
import ansiEscapes, { clearTerminal } from "../ansi-escapes"
...
export default class Ink {
	...
	calculateLayout = () => {
		...
		const terminalWidth = (this.options.stdout as any).columns || 80
	...
	onRender: () => void = () => {
		...
		if (outputHeight >= (this.options.stdout as any).rows) {
