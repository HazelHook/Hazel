...
export const FolderHeartIcon = (props: IconProps) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
		...
		<path
			...
			strokeLinejoin="round"
			strokeWidth="2"
			d="M12 16.625c.35 0 3.5-1.701 3.5-4.083 0-1.191-1.05-2.027-2.1-2.042-.525-.007-1.05.17-1.4.68-.35-.51-.884-.68-1.4-.68-1.05 0-2.1.85-2.1 2.042 0 2.382 3.15 4.083 3.5 4.083Z"
		/>
		<title>folderHeartIcon</title>
	</svg>
)
