...
export const FolderSecurityIcon = (props: IconProps) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
		...
		<path
			...
			strokeLinejoin="round"
			strokeWidth="2"
			d="m9.736 10.873 1.875-.677c.23-.083.48-.083.71 0l1.902.687c.386.14.655.492.687.902l.079 1.027a3.83 3.83 0 0 1-1.994 3.66l-.519.281a1.044 1.044 0 0 1-1.014-.01l-.53-.303a3.829 3.829 0 0 1-1.93-3.473l.045-1.152c.016-.425.289-.797.689-.942Z"
		/>
		<title>folderSecurityIcon</title>
	</svg>
)
