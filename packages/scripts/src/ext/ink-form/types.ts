...
export type ValueOfField<T extends FormField> = T extends AbstractFormField<
  any,
  infer V
>
  ? V
  : never;
export type TypeOfField<T extends FormField> = T extends AbstractFormField<
  infer V,
  any
>
  ? V
...
export type FormFieldMultiSelect = AbstractFormField<
  "multiselect",
  string[]
> & {
  options: Array<{ label?: string; value: string }>;
...
export type SpecificFormFieldRendererProps<T extends FormField> =
