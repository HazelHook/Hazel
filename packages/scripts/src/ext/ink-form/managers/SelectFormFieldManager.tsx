...
export class SelectFormFieldManager
  implements FormFieldManager<FormFieldSelect>
{
  public type: TypeOfField<FormFieldSelect> = "select";

  public renderField: React.FC<
    SpecificFormFieldRendererProps<FormFieldSelect>
  > = (props) => (
  ...
  public renderValue: React.FC<FormFieldValueRendererProps<FormFieldSelect>> = (
    props
  ) => (
    <>
