...
export class DrizzleTable<T extends TableConfig<AnyMySqlColumn>> {
  ...
  public async findFirst(
    data: Parameters<(typeof this.db.query)[typeof this.name]["findFirst"]>
  ) {
    // @ts-expect-error
  ...
  public insert(
    data: Parameters<
      ReturnType<typeof this.db.insert<typeof this.table>>["values"]
    >
  ) {
  ...
  public delete(
    data: Parameters<
      ReturnType<typeof this.db.delete<typeof this.table>>["where"]
    >
  ) {
  ...
  public update(
    data: Parameters<
      ReturnType<typeof this.db.update<typeof this.table>>["set"]
    >
  ) {
  ...
  public select(data?: Parameters<(typeof this.db)["select"]>) {
    return data
      ? this.db.select(...data).from(this.table)
  ...
  public get selectDistinct() {
    return (
      data: Parameters<
        ReturnType<typeof this.db.selectDistinct<typeof this.table>>["from"]
      >
